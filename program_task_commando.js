...
class Task_Commando extends Task
{
    constructor (...args)
    {
        super(...args);
    ...
    selectTargetEnRouteToPrimaryTarget(creep, target)
    {
        ...
        {
            console.log('Task_Commando.selectTargetEnRouteToPrimaryTarget - ' + creep.pos + ' -> ' + target.pos + ' - could not find path');
            return null;
        }
